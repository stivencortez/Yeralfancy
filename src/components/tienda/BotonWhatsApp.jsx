...
export function BotonWhatsApp() {
  ...
  return (
    <button
      ...
      className="fixed right-4 z-30 w-13 h-13 bg-green-500 text-white rounded-full flex items-center justify-center shadow-lg hover:bg-green-600 active:scale-90 transition-all duration-200 lg:bottom-6"

                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2">
                          <div className="w-8 h-8 rounded-lg overflow-hidden bg-marca-beige shrink-0">
                            {fotoCapa(p) ? <img src={imgSrc(fotoCapa(p), 100)} alt="" className={estiloCapa(p.capa).className} style={estiloCapa(p.capa).style} /> : <Package size={12} className="text-marca-beige-borde m-auto mt-2" />}
                          </div>
                          <div>
